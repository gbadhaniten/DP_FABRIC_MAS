"""DataWranglerAgent -- AI/Advanced Agent. Visual data preparation, profiling, and transformation."""
...
class DataWranglerAgent(BaseAgent):
    """Visual data preparation, profiling, and transformation."""
    ITEM_TYPE = "DataWrangler"
    ITEM_CODE = "DWR"
    FAB_NOUN = "data-wrangler"
    AGENT_FOLDER_NAME = "data-wrangler-agent"

    def create(self, params: Dict[str, Any]) -> AgentResult:
        self._autotrain("create")
        dn = params.get("display_name", "Untitled_DataWrangler")
        ...
        if r.success: r.message = f"DataWrangler '{dn}' created"; r.data = {"display_name": dn, "workspace_id": ws}
        return r
