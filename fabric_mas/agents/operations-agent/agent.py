"""OperationsAgentAgent -- AI/Advanced Agent. Platform observability, health monitoring, and diagnostics."""
...
class OperationsAgentAgent(BaseAgent):
    """Platform observability, health monitoring, and diagnostics."""
    ITEM_TYPE = "OperationsAgent"
    ITEM_CODE = "OPA"
    FAB_NOUN = "operations-agent"
    AGENT_FOLDER_NAME = "operations-agent"

    def create(self, params: Dict[str, Any]) -> AgentResult:
        self._autotrain("create")
        dn = params.get("display_name", "Untitled_OperationsAgent")
        ...
        if r.success: r.message = f"OperationsAgent '{dn}' created"; r.data = {"display_name": dn, "workspace_id": ws}
        return r
