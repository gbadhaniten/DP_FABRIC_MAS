"""
AzureDataFactoryAgent — Data Integration Agent
==================================================
Azure Data Factory cloud-scale ETL/ELT integration.

Item: AzureDataFactory (ADF)
CLI:  fab adf <verb> [options]
"""
...
class AzureDataFactoryAgent(BaseAgent):
    """Azure Data Factory cloud-scale ETL/ELT integration."""

    ITEM_TYPE = "AzureDataFactory"
    ITEM_CODE = "ADF"
    FAB_NOUN = "adf"
    AGENT_FOLDER_NAME = "adf-agent"

    # ── CREATE ────────────────────────────────────────────────────────
    def create(self, params: Dict[str, Any]) -> AgentResult:
        """Create a new AzureDataFactory in the workspace."""
        self._autotrain("create")
        display_name = params.get("display_name", "Untitled_AzureDataFactory")
    ...
    def analyze(self, item_id: Optional[str] = None, **kwargs: Any) -> AgentResult:
        """List or inspect AzureDataFactory items."""
    ...
    def deploy(self, item_id: str, target: str, **kwargs: Any) -> AgentResult:
        """Deploy AzureDataFactory to a target workspace."""
