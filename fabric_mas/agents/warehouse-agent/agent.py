"""
WarehouseAgent — Analytics/Warehousing Agent
================================================
Fabric Synapse Data Warehouse with full T-SQL and cross-database query support.

Item: Warehouse (WH)
CLI:  fab warehouse <verb> [options]
"""
...
class WarehouseAgent(BaseAgent):
    ...
    def create(self, params: Dict[str, Any]) -> AgentResult:
        ...
        if result.success:
            result.message = f"Warehouse '{display_name}' created in workspace {ws}"
    ...
    def analyze(self, item_id: Optional[str] = None, **kwargs: Any) -> AgentResult:
        """List or inspect Warehouse items."""
    ...
    def deploy(self, item_id: str, target: str, **kwargs: Any) -> AgentResult:
        """Deploy Warehouse to a target workspace."""
