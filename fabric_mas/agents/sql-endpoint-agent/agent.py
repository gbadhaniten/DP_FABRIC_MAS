"""
SQLAnalyticsEndpointAgent — Analytics/Warehousing Agent
===========================================================
Auto-generated read-only SQL endpoint over Lakehouse Delta tables.

Item: SQLAnalyticsEndpoint (SQL)
CLI:  fab sql-endpoint <verb> [options]
"""
...
class SQLAnalyticsEndpointAgent(BaseAgent):
    """Auto-generated read-only SQL endpoint over Lakehouse Delta tables."""

    ITEM_TYPE = "SQLAnalyticsEndpoint"
    ITEM_CODE = "SQL"
    FAB_NOUN = "sql-endpoint"
    AGENT_FOLDER_NAME = "sql-endpoint-agent"

    # ── CREATE ────────────────────────────────────────────────────────
    def create(self, params: Dict[str, Any]) -> AgentResult:
        """Create a new SQLAnalyticsEndpoint in the workspace."""
        self._autotrain("create")
        display_name = params.get("display_name", "Untitled_SQLAnalyticsEndpoint")
        ...
        if result.success:
            result.message = f"SQLAnalyticsEndpoint '{display_name}' created in workspace {ws}"
            result.data = {"display_name": display_name, "workspace_id": ws}
        return result

    # ── UPDATE ────────────────────────────────────────────────────────
    def update(self, item_id: str, params: Dict[str, Any]) -> AgentResult:
        """Update an existing SQLAnalyticsEndpoint."""
    ...
    def analyze(self, item_id: Optional[str] = None, **kwargs: Any) -> AgentResult:
        """List or inspect SQLAnalyticsEndpoint items."""
    ...
    def deploy(self, item_id: str, target: str, **kwargs: Any) -> AgentResult:
        """Deploy SQLAnalyticsEndpoint to a target workspace."""
