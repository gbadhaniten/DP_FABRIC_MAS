"""
PowerBIAppAgent — Reporting/Power BI Agent
==============================================
Published Power BI application for end-user consumption.

Item: PowerBIApp (APP)
CLI:  fab app <verb> [options]
"""
...
class PowerBIAppAgent(BaseAgent):
    """Published Power BI application for end-user consumption."""

    ITEM_TYPE = "PowerBIApp"
    ITEM_CODE = "APP"
    FAB_NOUN = "app"
    AGENT_FOLDER_NAME = "powerbi-app-agent"

    # ── CREATE ────────────────────────────────────────────────────────
    def create(self, params: Dict[str, Any]) -> AgentResult:
        """Create a new PowerBIApp in the workspace."""
        self._autotrain("create")
        display_name = params.get("display_name", "Untitled_PowerBIApp")
    ...
    def analyze(self, item_id: Optional[str] = None, **kwargs: Any) -> AgentResult:
        """List or inspect PowerBIApp items."""
    ...
    def deploy(self, item_id: str, target: str, **kwargs: Any) -> AgentResult:
        """Deploy PowerBIApp to a target workspace."""
