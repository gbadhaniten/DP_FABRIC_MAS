"""VariableLibraryAgent -- Governance/Admin Agent. Shared variables and parameters reusable across Fabric items."""
...
class VariableLibraryAgent(BaseAgent):
    """Shared variables and parameters reusable across Fabric items."""
    ITEM_TYPE = "VariableLibrary"
    ITEM_CODE = "VL"
    FAB_NOUN = "variable-library"
    AGENT_FOLDER_NAME = "variable-library-agent"

    def create(self, params: Dict[str, Any]) -> AgentResult:
        self._autotrain("create")
        dn = params.get("display_name", "Untitled_VariableLibrary")
        ...
        if r.success: r.message = f"VariableLibrary '{dn}' created"; r.data = {"display_name": dn, "workspace_id": ws}
        return r
