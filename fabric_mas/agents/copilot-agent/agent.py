"""AICopilotAgent -- AI/Advanced Agent. Fabric Copilot AI integration for conversational data interaction."""
...
class AICopilotAgent(BaseAgent):
    """Fabric Copilot AI integration for conversational data interaction."""
    ITEM_TYPE = "AICopilot"
    ITEM_CODE = "COP"
    FAB_NOUN = "copilot"
    AGENT_FOLDER_NAME = "copilot-agent"

    def create(self, params: Dict[str, Any]) -> AgentResult:
        self._autotrain("create")
        dn = params.get("display_name", "Untitled_AICopilot")
        ...
        if r.success: r.message = f"AICopilot '{dn}' created"; r.data = {"display_name": dn, "workspace_id": ws}
        return r
