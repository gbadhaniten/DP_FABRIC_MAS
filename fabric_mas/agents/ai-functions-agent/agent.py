"""AIFunctionsAgent -- AI/Advanced Agent. Built-in AI/ML functions for data enrichment and inference."""
...
class AIFunctionsAgent(BaseAgent):
    """Built-in AI/ML functions for data enrichment and inference."""
    ITEM_TYPE = "AIFunctions"
    ITEM_CODE = "AIF"
    FAB_NOUN = "ai-functions"
    AGENT_FOLDER_NAME = "ai-functions-agent"

    def create(self, params: Dict[str, Any]) -> AgentResult:
        self._autotrain("create")
        dn = params.get("display_name", "Untitled_AIFunctions")
        ...
        if r.success: r.message = f"AIFunctions '{dn}' created"; r.data = {"display_name": dn, "workspace_id": ws}
        return r
