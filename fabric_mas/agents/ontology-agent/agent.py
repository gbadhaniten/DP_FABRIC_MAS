"""OntologyAgent -- AI/Advanced Agent. Data semantic ontology definitions and business glossary."""
...
class OntologyAgent(BaseAgent):
    """Data semantic ontology definitions and business glossary."""
    ITEM_TYPE = "Ontology"
    ITEM_CODE = "ONT"
    FAB_NOUN = "ontology"
    AGENT_FOLDER_NAME = "ontology-agent"

    def create(self, params: Dict[str, Any]) -> AgentResult:
        self._autotrain("create")
        dn = params.get("display_name", "Untitled_Ontology")
        ...
        if r.success: r.message = f"Ontology '{dn}' created"; r.data = {"display_name": dn, "workspace_id": ws}
        return r
